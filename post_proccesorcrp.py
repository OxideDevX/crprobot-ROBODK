# Copyright 2022 - RoboDK Software S.L. - http://www.robodk.com/
...
# for a CRP(CHINA) robot with RoboDK
#
...
class RobotPost(object):
    ...
    def __init__(self, robotpost=None, robotname=CRP, robot_axes = 6, **kwargs):
